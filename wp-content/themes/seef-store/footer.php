...
<footer class="site-footer">
	<div class="seef-shell seef-footer-grid">
		<div><a class="seef-brand seef-brand--footer" href="<?php echo esc_url( home_url( '/' ) ); ?>"><span class="seef-brand-mark">S</span><span>SEEF <b>STORE</b></span></a><p><?php esc_html_e( 'Une boutique pensée pour mieux vivre avec la technologie.', 'seef-store' ); ?></p><small><?php esc_html_e( 'Contenu et témoignages de démonstration.', 'seef-store' ); ?></small></div>
