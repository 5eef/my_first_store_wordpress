	...
	<div class="seef-shell seef-header-inner">
		...
		>
         <img
			 ...
			 src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/logo-seef-store.png' ); ?>"
		...
		<div class="seef-header-actions">
			...
			<a class="seef-icon-link" href="<?php echo esc_url( seef_store_wc_url( 'myaccount' ) ); ?>" aria-label="<?php esc_attr_e( 'Mon compte', 'seef-store' ); ?>"><?php echo seef_store_icon( 'user' ); ?></a>
			<a class="seef-icon-link seef-cart-link" href="<?php echo esc_url( seef_store_wc_url( 'cart' ) ); ?>" aria-label="<?php esc_attr_e( 'Panier', 'seef-store' ); ?>"><?php echo seef_store_icon( 'cart' ); ?><span class="seef-cart-count"><?php echo esc_html( (string) seef_store_cart_count() ); ?></span></a>
		</div>
	</div>
	<div class="seef-header-nav">
		<div class="seef-shell seef-nav-inner">
			<div class="seef-category-menu">
				<a class="seef-category-trigger" href="<?php echo esc_url( seef_store_wc_url( 'shop' ) ); ?>"><?php echo seef_store_icon( 'grid' ); ?><?php esc_html_e( 'Catégories', 'seef-store' ); ?><?php echo seef_store_icon( 'chevron', 'seef-icon-chevron' ); ?></a>
			...
			<a class="seef-nav-offer" href="<?php echo esc_url( seef_store_wc_url( 'shop' ) ); ?>"><span><?php esc_html_e( 'Nouveau', 'seef-store' ); ?></span><?php esc_html_e( 'Sélection 2026', 'seef-store' ); ?> →</a>
		</div>
	</div>
